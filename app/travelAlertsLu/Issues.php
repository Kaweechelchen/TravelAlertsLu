...
class Issues
{
    public static function getLineIssues($app)
    {
    ...
    public static function getRawData($app)
    {
    ...
    public static function xml2Array($xmlUrl)
    {
    ...
    public static function removeMetaData($rawData)
    {
    ...
    public static function removeNewLines($minifiedData)
    {
    ...
    public static function reFactorDates($issue, $date)
    {
    ...
    public static function getByLine($app, $line)
    {
        $getIssues = 'SELECT *
        FROM      issues
        WHERE     line = ?
